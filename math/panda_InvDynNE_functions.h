...
a1[4]=state[1].thd*v1[5] + DHD1*a0[2]*S10[1][1] + a0[4]*S10[1][1] - DHD1*a0[1]*S10[1][2] + a0[5]*S10[1][2];
a1[5]=-(state[1].thd*v1[4]) + DHD1*a0[2]*S10[2][1] + a0[4]*S10[2][1] - DHD1*a0[1]*S10[2][2] + a0[5]*S10[2][2];
a1[6]=a0[6];
...
fext0[4]=fex0[4] + fext1[4]*Si01[1][1] + fext1[5]*Si01[1][2] - DHD1*fext1[1]*Si01[2][1] - DHD1*fext1[2]*Si01[2][2];
fext0[5]=fex0[5] + DHD1*fext1[1]*Si01[1][1] + DHD1*fext1[2]*Si01[1][2] + fext1[4]*Si01[2][1] + fext1[5]*Si01[2][2];
