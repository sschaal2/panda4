...
Xinv[1][4][1]=-(DHD1*sstate1th);
Xinv[1][4][2]=-(cstate1th*DHD1);
Xinv[1][4][3]=0;
Xinv[1][4][4]=cstate1th;
Xinv[1][4][5]=-sstate1th;
Xinv[1][4][6]=0;

Xinv[1][5][1]=cstate1th*DHD1;
Xinv[1][5][2]=-(DHD1*sstate1th);
Xinv[1][5][3]=0;
...
v1[4]=-(DHD1*sstate1th*v0[1]) + cstate1th*DHD1*v0[2] + cstate1th*v0[4] + sstate1th*v0[5];
v1[5]=-(cstate1th*DHD1*v0[1]) - DHD1*sstate1th*v0[2] - sstate1th*v0[4] + cstate1th*v0[5];
v1[6]=v0[6];
...
a1[4]=-(DHD1*sstate1th*a0[1]) + cstate1th*DHD1*a0[2] + cstate1th*a0[4] + sstate1th*a0[5] + state[1].thd*v1[5];
a1[5]=-(cstate1th*DHD1*a0[1]) - DHD1*sstate1th*a0[2] - sstate1th*a0[4] + cstate1th*a0[5] - state[1].thd*v1[4];
a1[6]=a0[6];
